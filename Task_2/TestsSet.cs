...
namespace Task_2
{
    public class TestsSet
    {
        ...
        {
            await BaseTest(3, HttpMethod.Get, "/Rates/USD/EUR", 200,
        ...
        {
            await BaseTest(4, HttpMethod.Get, "/Rates/USD/EUR", 401, 
